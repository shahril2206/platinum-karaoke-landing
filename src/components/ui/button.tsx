  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary/50 bg-transparent text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300",
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_30px_rgba(var(--primary)/0.3)] hover:shadow-[0_0_40px_rgba(var(--primary)/0.5)] hover:scale-105 transition-all duration-300",
        premium: "bg-gradient-to-r from-primary to-secondary text-foreground hover:opacity-90 shadow-[0_0_30px_rgba(var(--accent)/0.3)] hover:shadow-[0_0_40px_rgba(var(--accent)/0.5)] transition-all duration-300",
      },
      size: {
